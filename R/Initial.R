...
initial <- function(p, ...) {
    ...
    default <- c(
        ...
        Dx_500 = (userDx - userCare) * p[["prop_preART_500"]],
        Dx_350500 = (userDx - userCare) * p[["prop_preART_350500"]],
        Dx_250350 = (userDx - userCare) * p[["prop_preART_250350"]],
        Dx_200250 = (userDx - userCare) * p[["prop_preART_200250"]],
        Dx_100200 = (userDx - userCare) * p[["prop_preART_100200"]],
        Dx_50100 = (userDx - userCare) * p[["prop_preART_50100"]],
        Dx_50 = (userDx - userCare) * p[["prop_preART_50"]],
