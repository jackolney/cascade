...
void calib_derivs(int *neq, double *t, double *y, double *ydot, double *yout, int *ip) {
    ...
    // 'Tx_A' section
    ydot[35] = parms.Sigma * y[Tx_Na_500] +     ((yr >= parms.t_1) * parms.s_1 * parms.p * parms.Theta) * y[PreLtfu_500] +    (((yr >= parms.t_1) * parms.p * parms.Gamma) + ((yr >= parms.t_1) * parms.s_1 * parms.p * parms.Theta)) * y[Care_500] +    ((yr >= parms.t_1) * parms.s_1 * parms.p * parms.Theta) * y[Dx_500] +    ((yr >= parms.t_1) * parms.s_1 * parms.p * parms.Theta) * y[UnDx_500] - (parms.Omega + parms.Tau_1) * y[Tx_A_500];
    ydot[36] = parms.Sigma * y[Tx_Na_350500] +  ((yr >= parms.t_2) * parms.s_2 * parms.p * parms.Theta) * y[PreLtfu_350500] + (((yr >= parms.t_2) * parms.p * parms.Gamma) + ((yr >= parms.t_2) * parms.s_2 * parms.p * parms.Theta)) * y[Care_350500] + ((yr >= parms.t_2) * parms.s_2 * parms.p * parms.Theta) * y[Dx_350500] + ((yr >= parms.t_2) * parms.s_2 * parms.p * parms.Theta) * y[UnDx_350500] + parms.Delta_1 * y[Tx_A_250350] - (parms.Omega + parms.Tau_2) * y[Tx_A_350500];
    ydot[37] = parms.Sigma * y[Tx_Na_250350] +  ((yr >= parms.t_3) * parms.s_3 * parms.p * parms.Theta) * y[PreLtfu_250350] + (((yr >= parms.t_3) * parms.p * parms.Gamma) + ((yr >= parms.t_3) * parms.s_3 * parms.p * parms.Theta)) * y[Care_250350] + ((yr >= parms.t_3) * parms.s_3 * parms.p * parms.Theta) * y[Dx_250350] + ((yr >= parms.t_3) * parms.s_3 * parms.p * parms.Theta) * y[UnDx_250350] + parms.Delta_2 * y[Tx_A_200250] - (parms.Delta_1 + parms.Omega + parms.Tau_3) * y[Tx_A_250350];
    ydot[38] = parms.Sigma * y[Tx_Na_200250] +  ((yr >= parms.t_4) * parms.s_4 * parms.p * parms.Theta) * y[PreLtfu_200250] + (((yr >= parms.t_4) * parms.p * parms.Gamma) + ((yr >= parms.t_4) * parms.s_4 * parms.p * parms.Theta)) * y[Care_200250] + ((yr >= parms.t_4) * parms.s_4 * parms.p * parms.Theta) * y[Dx_200250] + ((yr >= parms.t_4) * parms.s_4 * parms.p * parms.Theta) * y[UnDx_200250] + parms.Delta_3 * y[Tx_A_100200] - (parms.Delta_2 + parms.Omega + parms.Tau_4) * y[Tx_A_200250];
    ydot[39] = parms.Sigma * y[Tx_Na_100200] +  ((yr >= parms.t_5) * parms.s_5 * parms.p * parms.Theta) * y[PreLtfu_100200] + (((yr >= parms.t_5) * parms.p * parms.Gamma) + ((yr >= parms.t_5) * parms.s_5 * parms.p * parms.Theta)) * y[Care_100200] + ((yr >= parms.t_5) * parms.s_5 * parms.p * parms.Theta) * y[Dx_100200] + ((yr >= parms.t_5) * parms.s_5 * parms.p * parms.Theta) * y[UnDx_100200] + parms.Delta_4 * y[Tx_A_50100] - (parms.Delta_3 + parms.Omega + parms.Tau_5) * y[Tx_A_100200];
    ydot[40] = parms.Sigma * y[Tx_Na_50100] +   ((yr >= parms.t_5) * parms.s_6 * parms.p * parms.Theta) * y[PreLtfu_50100] +  (((yr >= parms.t_5) * parms.p * parms.Gamma) + ((yr >= parms.t_5) * parms.s_6 * parms.p * parms.Theta)) * y[Care_50100] +  ((yr >= parms.t_5) * parms.s_6 * parms.p * parms.Theta) * y[Dx_50100] +  ((yr >= parms.t_5) * parms.s_6 * parms.p * parms.Theta) * y[UnDx_50100] + parms.Delta_5 * y[Tx_A_50] - (parms.Delta_4 + parms.Omega + parms.Tau_6) * y[Tx_A_50100];
    ydot[41] = parms.Sigma * y[Tx_Na_50] +      ((yr >= parms.t_5) * parms.s_7 * parms.p * parms.Theta) * y[PreLtfu_50] +     (((yr >= parms.t_5) * parms.p * parms.Gamma) + ((yr >= parms.t_5) * parms.s_7 * parms.p * parms.Theta)) * y[Care_50] +     ((yr >= parms.t_5) * parms.s_7 * parms.p * parms.Theta) * y[Dx_50] +     ((yr >= parms.t_5) * parms.s_7 * parms.p * parms.Theta) * y[UnDx_50] - (parms.Delta_5 + parms.Omega + parms.Tau_7) * y[Tx_A_50];
