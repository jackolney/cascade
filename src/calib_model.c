...
void calib_derivs(int *neq, double *t, double *y, double *ydot, double *yout, int *ip) {
    ...
    ydot[0] = (parms.prop_preART_500 * inc.inf[yr]) - (parms.Nu_1 + parms.Rho + (parms.ART_All * parms.s_1 * parms.p * parms.Theta) + (parms.ART_All * parms.s_1 * (1-parms.p) * parms.Theta) + parms.Alpha_1 + parms.Mu) * y[UnDx_500];
    ydot[1] = (parms.prop_preART_350500 * inc.inf[yr]) + parms.Nu_1 * y[UnDx_500] - (parms.Nu_2 + parms.Rho + (parms.ART_500 * parms.s_2 * parms.p * parms.Theta) + (parms.ART_500 * parms.s_2 * (1-parms.p) * parms.Theta) + parms.Alpha_2 + parms.Mu) * y[UnDx_350500];
    ydot[2] = (parms.prop_preART_250350 * inc.inf[yr]) + parms.Nu_2 * y[UnDx_350500] - (parms.Nu_3 + parms.Rho + (parms.ART_350 * parms.s_3 * parms.p * parms.Theta) + (parms.ART_350 * parms.s_3 * (1-parms.p) * parms.Theta) + parms.Alpha_3 + parms.Mu) * y[UnDx_250350];
    ydot[3] = (parms.prop_preART_200250 * inc.inf[yr]) + parms.Nu_3 * y[UnDx_250350] - (parms.Nu_4 + parms.Rho + (parms.ART_350 * parms.s_4 * parms.p * parms.Theta) + (parms.ART_350 * parms.s_4 * (1-parms.p) * parms.Theta) + parms.Alpha_4 + parms.Mu) * y[UnDx_200250];
    ydot[4] = (parms.prop_preART_100200 * inc.inf[yr]) + parms.Nu_4 * y[UnDx_200250] - (parms.Nu_5 + parms.Rho + (parms.ART_200 * parms.s_5 * parms.p * parms.Theta) + (parms.ART_200 * parms.s_5 * (1-parms.p) * parms.Theta) + parms.Alpha_5 + parms.Mu) * y[UnDx_100200];
    ydot[5] = (parms.prop_preART_50100 * inc.inf[yr]) + parms.Nu_5 * y[UnDx_100200] - (parms.Nu_6 + parms.Rho + (parms.ART_200 * parms.s_6 * parms.p * parms.Theta) + (parms.ART_200 * parms.s_6 * (1-parms.p) * parms.Theta) + parms.Alpha_6 + parms.Mu) * y[UnDx_50100];
    ydot[6] = (parms.prop_preART_50 * inc.inf[yr]) + parms.Nu_6 * y[UnDx_50100] - (parms.Rho + (parms.ART_200 * parms.s_7 * parms.p * parms.Theta) + (parms.ART_200 * parms.s_7 * (1-parms.p) * parms.Theta) + parms.Alpha_7 + parms.Mu) * y[UnDx_50];
    ...
    ydot[14] = (parms.q * parms.Epsilon) * y[Dx_500] - (parms.Nu_1 + parms.Kappa + (parms.ART_All * parms.p * parms.Gamma) + (parms.ART_All * parms.s_1 * parms.p * parms.Theta) + (parms.ART_500 * (1-parms.p) * parms.Gamma) + (parms.ART_500 * parms.s_1 * (1-parms.p) * parms.Theta) + parms.Alpha_1 + parms.Mu) * y[Care_500];
    ydot[15] = (parms.q * parms.Epsilon) * y[Dx_350500] + parms.Nu_1 * y[Care_500] - (parms.Nu_2 + parms.Kappa + (parms.ART_500 * parms.p * parms.Gamma) + (parms.ART_500 * parms.s_2 * parms.p * parms.Theta) + (parms.ART_500 * (1-parms.p) * parms.Gamma) + (parms.ART_500 * parms.s_2 * (1-parms.p) * parms.Theta) + parms.Alpha_2 + parms.Mu) * y[Care_350500];
    ydot[16] = (parms.q * parms.Epsilon) * y[Dx_250350] + parms.Nu_2 * y[Care_350500] - (parms.Nu_3 + parms.Kappa + (parms.ART_350 * parms.p * parms.Gamma) + (parms.ART_350 * parms.s_3 * parms.p * parms.Theta) + (parms.ART_350 * (1-parms.p) * parms.Gamma) + (parms.ART_350 * parms.s_3 * (1-parms.p) * parms.Theta) + parms.Alpha_3 + parms.Mu) * y[Care_250350];
    ydot[17] = (parms.q * parms.Epsilon) * y[Dx_200250] + parms.Nu_3 * y[Care_250350] - (parms.Nu_4 + parms.Kappa + (parms.ART_350 * parms.p * parms.Gamma) + (parms.ART_350 * parms.s_4 * parms.p * parms.Theta) + (parms.ART_350 * (1-parms.p) * parms.Gamma) + (parms.ART_350 * parms.s_4 * (1-parms.p) * parms.Theta) + parms.Alpha_4 + parms.Mu) * y[Care_200250];
    ydot[18] = (parms.q * parms.Epsilon) * y[Dx_100200] + parms.Nu_4 * y[Care_200250] - (parms.Nu_5 + parms.Kappa + (parms.ART_200 * parms.p * parms.Gamma) + (parms.ART_200 * parms.s_5 * parms.p * parms.Theta) + (parms.ART_200 * (1-parms.p) * parms.Gamma) + (parms.ART_200 * parms.s_5 * (1-parms.p) * parms.Theta) + parms.Alpha_5 + parms.Mu) * y[Care_100200];
    ydot[19] = (parms.q * parms.Epsilon) * y[Dx_50100] + parms.Nu_5 * y[Care_100200] - (parms.Nu_6 + parms.Kappa + (parms.ART_200 * parms.p * parms.Gamma) + (parms.ART_200 * parms.s_6 * parms.p * parms.Theta) + (parms.ART_200 * (1-parms.p) * parms.Gamma) + (parms.ART_200 * parms.s_6 * (1-parms.p) * parms.Theta) + parms.Alpha_6 + parms.Mu) * y[Care_50100];
    ydot[20] = (parms.q * parms.Epsilon) * y[Dx_50] + parms.Nu_6 * y[Care_50100] - (parms.Kappa + (parms.ART_200 * parms.p * parms.Gamma) + (parms.ART_200 * parms.s_7 * parms.p * parms.Theta) + (parms.ART_200 * (1-parms.p) * parms.Gamma) + (parms.ART_200 * parms.s_7 * (1-parms.p) * parms.Theta) + parms.Alpha_7 + parms.Mu) * y[Care_50];

    ydot[21] = parms.Kappa * y[Care_500] + ((1-parms.q) * parms.Epsilon) * y[Dx_500] - (parms.Nu_1 + (parms.ART_All * parms.s_1 * parms.p * parms.Theta) + (parms.ART_All * parms.s_1 * (1-parms.p) * parms.Theta) + parms.Alpha_1 + parms.Mu) * y[PreLtfu_500];
    ydot[22] = parms.Kappa * y[Care_350500] + parms.Nu_1 * y[PreLtfu_500] + ((1-parms.q) * parms.Epsilon) * y[Dx_350500] - (parms.Nu_2 + (parms.ART_500 * parms.s_2 * parms.p * parms.Theta) + (parms.ART_500 * parms.s_2 * (1-parms.p) * parms.Theta) + parms.Alpha_2 + parms.Mu) * y[PreLtfu_350500];
    ydot[23] = parms.Kappa * y[Care_250350] + parms.Nu_2 * y[PreLtfu_350500] + ((1-parms.q) * parms.Epsilon) * y[Dx_250350] - (parms.Nu_3 + (parms.ART_350 * parms.s_3 * parms.p * parms.Theta) + (parms.ART_350 * parms.s_3 * (1-parms.p) * parms.Theta) + parms.Alpha_3 + parms.Mu) * y[PreLtfu_250350];
    ydot[24] = parms.Kappa * y[Care_200250] + parms.Nu_3 * y[PreLtfu_250350] + ((1-parms.q) * parms.Epsilon) * y[Dx_200250] - (parms.Nu_4 + (parms.ART_350 * parms.s_4 * parms.p * parms.Theta) + (parms.ART_350 * parms.s_4 * (1-parms.p) * parms.Theta) + parms.Alpha_4 + parms.Mu) * y[PreLtfu_200250];
    ydot[25] = parms.Kappa * y[Care_100200] + parms.Nu_4 * y[PreLtfu_200250] + ((1-parms.q) * parms.Epsilon) * y[Dx_100200] - (parms.Nu_5 + (parms.ART_200 * parms.s_5 * parms.p * parms.Theta) + (parms.ART_200 * parms.s_5 * (1-parms.p) * parms.Theta) + parms.Alpha_5 + parms.Mu) * y[PreLtfu_100200];
    ydot[26] = parms.Kappa * y[Care_50100] + parms.Nu_5 * y[PreLtfu_100200] + ((1-parms.q) * parms.Epsilon) * y[Dx_50100] - (parms.Nu_6 + (parms.ART_200 * parms.s_6 * parms.p * parms.Theta) + (parms.ART_200 * parms.s_6 * (1-parms.p) * parms.Theta) + parms.Alpha_6 + parms.Mu) * y[PreLtfu_50100];
    ydot[27] = parms.Kappa * y[Care_50] + parms.Nu_6 * y[PreLtfu_50100] + ((1-parms.q) * parms.Epsilon) * y[Dx_50] - ((parms.ART_200 * parms.s_7 * parms.p * parms.Theta) + (parms.ART_200 * parms.s_7 * (1-parms.p) * parms.Theta) + parms.Alpha_7 + parms.Mu) * y[PreLtfu_50];
