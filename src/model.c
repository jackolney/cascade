...
void derivs(int *neq, double *t, double *y, double *ydot, double *yout, int *ip) {
    ...
    // CumLink
    ydot[53] = ((((yr >= parms.t_1) * parms.s_1 * y[UnDx_500]) + ((yr >= parms.t_2) * parms.s_2 * y[UnDx_350500]) + ((yr >= parms.t_3) * parms.s_3 * y[UnDx_250350]) + ((yr >= parms.t_4) * parms.s_4 * y[UnDx_200250]) + ((yr >= parms.t_5) * parms.s_5 * y[UnDx_100200]) + ((yr >= parms.t_5) * parms.s_6 * y[UnDx_50100]) + ((yr >= parms.t_5) * parms.s_7 * y[UnDx_50]) ) * parms.Theta) + ((((yr >= parms.t_1) * parms.s_1 * y[Dx_500]) + ((yr >= parms.t_2) * parms.s_2 * y[Dx_350500]) + ((yr >= parms.t_3) * parms.s_3 * y[Dx_250350]) + ((yr >= parms.t_4) * parms.s_4 * y[Dx_200250]) + ((yr >= parms.t_5) * parms.s_5 * y[Dx_100200]) + ((yr >= parms.t_5) * parms.s_6 * y[Dx_50100]) + ((yr >= parms.t_5) * parms.s_7 * y[Dx_50]) ) * parms.Theta) + ((y[Dx_500]   + y[Dx_350500]   + y[Dx_250350]   + y[Dx_200250]   + y[Dx_100200]   + y[Dx_50100]   + y[Dx_50]) * (parms.Epsilon * parms.q));
